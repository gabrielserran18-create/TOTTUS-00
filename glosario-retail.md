...
| **F8** | `LANZAMIENTOS_2024_2025.xlsx`, `Lanzamientos_Dic_Ene_Feb.xlsx`, `Lanzamientos_MMPP_31.08.xlsx` + deck `Lanzamientos MMPP - 2026` (77 láminas) | Bases + deck de lanzamientos | 2024 a 31-Ago-2026 | Histórico, ejecución del trimestre y pipeline vigente (167 SKU, 56 proyectos) de lanzamientos de marca propia. **Las 3 bases están en el repo, en [`fuentes/lanzamientos/`](fuentes/lanzamientos/)** — detalle SKU a SKU con fecha exacta de lanzamiento para consulta puntual (el glosario extrae terminología, no reproduce la base fila por fila) |
